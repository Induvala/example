...
const products = [
    {
        ...
        colors: ["#f5ba0a", "#574f19", "#4c4c4c", "#ffffff", "#f5ba0a", "#f5ba0a", "#f5ba0a", "#f5ba0a", "#f5ba0a", "#f5ba0a"],
...
const ProductSection: React.FC = () => {
    return (
        <section className="max-w-7xl mx-auto py-10 px-4 text-center">
            ...
            <div className="grid mt-10 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
