    ...
    <>
      <div className="w-full sm:w-[500px] bg-white shadow-xl rounded-2xl p-10 border border-gray-200">
        ...
        <div className="mb-5 block md:flex justify-between items-center">
          ...
          <div className="block w-full">
            <BasicInput
              ...
              className={`w-full px-4 py-3 rounded-lg focus:outline-none focus:ring-2  ${(userId !== "IDIDID222" && error?.field === "userId") ? "border bg-red-50 border-red-400 focus:ring-red-400 focus:border-red-400"
        ...
        <div className="mb-3 block md:flex">
          ...
          <div className="block relative w-full">
            <BasicInput
              ...
              className={`w-full rounded-md px-4 py-3 pr-10 focus:outline-none focus:ring-2 ${(error?.field === "password" || (password && !isPasswordValid))
        ...
        <button
          type="submit"
          onClick={handleLogin}
          className={`w-full py-3 font-semibold rounded-lg transition ${isFormValid
